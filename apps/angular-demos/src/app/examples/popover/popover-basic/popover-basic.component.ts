  ...
  template: `
	<div class="row">
	  <div class="col-2 text--center">
		<div>
      <span class="icon-warning-circle"
			[fdsPopoverBody]="'Small simple tooltip with text and without title'"
			style="font-size: 1.5rem; color: var(--primary);"></span></div>
		<span>Text Only</span>
	  </div>
      ...
      <span class="icon-warning-circle"
			...
			[fdsPopoverBody]="'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry'"
			style="font-size: 1.5rem; color: var(--primary);"></span></div>
