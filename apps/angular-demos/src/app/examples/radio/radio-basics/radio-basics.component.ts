...
@Component({
  ...
  template: `
	<div class="row">
	  <div class="col-4">
		<label id="example-radio-group-label-1">Pick your favorite fruit (value)</label>
		<fds-radio-group
			aria-labelledby="example-radio-group-label-1"
			[value]="favoriteFruitValue" (change)="favoriteFruitValue=$event.value">
		  <fds-radio *ngFor="let fruit of fruits" [value]="fruit.value">{{fruit.title}}</fds-radio>
		</fds-radio-group>
		<pre>
favoriteFruitValue: {{favoriteFruitValue}}
	  ...
	  <div class="col-4">
		<label id="example-radio-group-label-2">Pick your favorite fruit (ngModel)</label>
		<fds-radio-group
...
favoriteFruitNgModel: {{favoriteFruitNgModel}}
	  ...
	  <form class="form" role="form" [formGroup]="form">
		<label id="example-radio-group-label-3">Pick your favorite fruit (ReactiveForms)</label>
		<fds-radio-group
