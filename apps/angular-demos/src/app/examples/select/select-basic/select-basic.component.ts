	  ...
	  <div class="row">
		<div class="col-4">
		  <fds-form-field>
			...
			<fds-error *ngIf="form.get('field1')?.hasError('required')">Field1 is required</fds-error>
		  </fds-form-field>
		...
		<div class="col-4">
		  <fds-form-field [clearBtn]="true">
			...
			<fds-error *ngIf="form.get('field2')?.hasError('required')">Field2 is required</fds-error>
		  </fds-form-field>
		...
		<div class="col-4">
		  <fds-form-field [clearBtn]="true">
			...
			<fds-error *ngIf="form.get('field3')?.hasError('required')">Field3 is required</fds-error>
		  </fds-form-field>
...
export class SelectBasicComponent implements OnInit {
  ...
  form = this.fb.group({
    ...
    field3: new FormControl({ value: "pottery", disabled: true }, Validators.required)
  });
