...
@Component({
  selector: 'demo-light-table-head',
  template: `
    <fds-table tableStyleClass="fds--table" [value]="tasks">
      // TODO: @Kashif please use this (fds--table--thead--light) class on thead Tag 
...
export class LightTableHeadComponent implements OnInit {
  tasks: Task[];
