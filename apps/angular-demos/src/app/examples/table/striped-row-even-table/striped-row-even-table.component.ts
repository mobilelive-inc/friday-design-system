...
@Component({
  selector: 'demo-striped-row-even-table',
  template: `
    <fds-table tableStyleClass="fds--table fds--table--striped--even" [value]="tasks">
...
export class StripedRowEvenTableComponent implements OnInit {
  tasks: Task[];
