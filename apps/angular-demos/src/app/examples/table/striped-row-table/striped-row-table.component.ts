...
@Component({
  selector: 'demo-striped-row-table',
  template: `
    <fds-table tableStyleClass="fds--table fds--table--striped" [value]="tasks">
...
export class StripedRowTableComponent implements OnInit {
  tasks: Task[];
