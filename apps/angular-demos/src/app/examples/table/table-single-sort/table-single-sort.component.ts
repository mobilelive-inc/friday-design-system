    ...
    <div>
      ...
      >
        <ng-template fdsTemplate="caption">
          <caption class="d--block text--left h4">
            Dynamic Table with Single Sort, Scrolling, Row Select and Table
            Styles
          </caption>
        </ng-template>
        ...
        <ng-template fdsTemplate="body" let-rowData let-columns="columns">
          <tr>
            ...
            <td>
              <fds-button
                className="btn btn--tooltip text--primary"
                (onClick)="selectTask(rowData)"
                >Edit</fds-button
              >
            </td>
          </tr>
