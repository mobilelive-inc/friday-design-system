...
@Component({
  ...
  template: `
    <fds-tabView>
      <fds-tabPanel>
        <ng-template fdsTemplate="header"><strong>Custom Header 1</strong></ng-template>
      ...
      <fds-tabPanel header="Header Text" leftIcon="icon-check" rightIcon="icon-warning-circle" [disabled]="true">
        Disabled content
      </fds-tabPanel>
