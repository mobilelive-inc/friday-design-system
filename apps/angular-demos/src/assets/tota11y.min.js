 ...
 */ !(function (n) {
    ...
    !(function (e, t) {
        ...
        C.extend({
          ...
          isPlainObject: function (e) {
            ...
            return (
              ...
              (!(t = r(e)) ||
                ('function' ==
                  typeof (n = b.call(t, 'constructor') && t.constructor) &&
                  i.call(n) === u))
            );
          },
      ...
      var g =
        ...
        (function (n) {
          ...
          try {
            P.apply((t = D.call(y.childNodes)), y.childNodes),
          ...
          function ae(e, t, n, r) {
            ...
            if (
              !r &&
              ((t ? t.ownerDocument || t : y) !== E && w(t), (t = t || E), A)
            ) {
              if (11 !== p && (l = Z.exec(e)))
                if ((o = l[1])) {
                  if (9 === p) {
          ...
          function ge(i) {
            return se(function (a) {
              return (
                (a = +a),
                se(function (e, t) {
                  for (var n, r = i([], e.length, a), o = r.length; o--; )
                    e[(n = r[o])] && (e[n] = !(t[n] = e[n]));
                })
              );
            });
          ...
          (w = ae.setDocument = function (e) {
            ...
            return (
              r !== E &&
                ...
                (f.getElementsByClassName = Q.test(E.getElementsByClassName)),
                ...
                (c = []),
                (m = []),
                (f.qsa = Q.test(E.querySelectorAll)) &&
                  (le(function (e) {
          ...
          (ae.attr = function (e, t) {
            ...
            var n = x.attrHandle[t.toLowerCase()],
              r =
                n && O.call(x.attrHandle, t.toLowerCase())
                  ? n(e, t, !A)
                  : void 0;
            return void 0 !== r
              ? r
          ...
          ((x = ae.selectors = {
                ...
                return 1 === h && 0 === m
                  ...
                  : function (e, t, n) {
                      var r,
                        ...
                        s,
                        l,
                        u = b != v ? 'nextSibling' : 'previousSibling',
                        c = e.parentNode,
                ...
                return i[C]
                  ...
                  ? ((t = [e, e, '', a]),
                    x.setFilters.hasOwnProperty(e.toLowerCase())
                      ? se(function (e, t) {
                          for (var n, r = i(e, a), o = r.length; o--; )
                            e[(n = M(e, r[o]))] = !(t[n] = r[o]);
                        })
                      : function (e) {
                          return i(e, 0, t);
            ...
            pseudos: {
              not: se(function (e) {
                ...
                return s[C]
                  ? se(function (e, t, n, r) {
                      for (var o, a = s(e, null, r, []), i = e.length; i--; )
                        (o = a[i]) && (e[i] = !(t[i] = o));
                    })
                  : function (e, t, n) {
                      return (
              ...
              lang: se(function (n) {
                return (
                  z.test(n || '') || ae.error('unsupported lang: ' + n),
            ...
            return (
              ...
              se(function (e, t, n, r) {
                var o,
                  ...
                  p = h ? (b || (e ? f : u || m) ? [] : t) : d;
                if ((h && h(d, p, n, r), m))
                  for (o = xe(p, l), m(o, [], n, r), a = o.length; a--; )
                    (i = o[a]) && (p[l[a]] = !(d[l[a]] = i));
                if (e) {
                  if (b || f) {
                    if (b) {
          ...
          return (
            ...
            (g = ae.tokenize = function (e, t) {
              ...
              for (i = e, s = [], l = x.preFilter; i; ) {
                for (a in ((n && !(r = V.exec(i))) ||
                  (r && (i = i.slice(r[0].length) || i), s.push((o = []))),
                (n = !1),
                (r = G.exec(i)) &&
                  ((n = r.shift()),
            ...
            (h = ae.select = function (e, t, n, r) {
              ...
              if (((n = n || []), 1 === c.length)) {
                if (
                  ...
                  if (
                    !(t = (x.find.ID(i.matches[0].replace(te, d), t) || [])[0])
                  )
                    return n;
                  u && (t = t.parentNode),
                ...
                for (
                  ...
                  o-- && ((i = a[o]), !x.relative[(s = i.type)]);

                )
                  if (
                    (l = x.find[s]) &&
                    (r = l(
                      i.matches[0].replace(te, d),
                      (ee.test(a[0].type) && he(t.parentNode)) || t
                    ))
                  ) {
                    if ((a.splice(o, 1), !(e = r.length && be(a))))
      ...
      (C.find = g),
        ...
        (C.uniqueSort = C.unique = g.uniqueSort),
        (C.text = g.getText),
        (C.isXMLDoc = g.isXML),
        (C.contains = g.contains),
        (C.escapeSelector = g.escape);
      function w(e, t, n) {
          ...
          function (r, o) {
            C.fn[r] = function (e, t) {
              ...
              return (
                ...
                1 < this.length &&
                  (P[r] || C.uniqueSort(n), I.test(r) && n.reverse()),
                this.pushStack(n)
              );
            };
          }
      ...
      (C.Callbacks = function (r) {
        ...
        C.extend({
              ...
              i = {
                ...
                then: function (t, n, r) {
                      ...
                      function e() {
                        ...
                        if (!(o < l)) {
                          ...
                          (t =
                            ...
                            y(t)
                              ? s
                                ? t.call(e, u(l, a, j, s), u(l, a, H, s))
                                : (l++,
                                  t.call(
                                    e,
                                    u(l, a, j, s),
                                    u(l, a, H, s),
                                    u(l, a, j, a.notifyWith)
                                  ))
                              : (i !== j && ((n = void 0), (r = [e])),
                                (s || a.resolveWith)(n, r));
                        }
                  ...
                  return C.Deferred(function (e) {
                    a[0][3].add(u(0, e, y(r) ? r : j, e.notifyWith)),
                      a[1][3].add(u(0, e, y(t) ? t : j)),
                      a[2][3].add(u(0, e, y(n) ? n : H));
                  }).promise();
                },
                promise: function (e) {
          ...
          when: function (e) {
            ...
            if (
              n <= 1 &&
              (q(e, i.done(t(r)).resolve, i.reject, !n),
              'pending' === i.state() || y(a[r] && a[r].then))
            )
              return i.then();
      ...
      C.extend({
        ...
        C.fn.extend({
          data: function (n, e) {
            ...
            if (
              this.length &&
              ((o = J.get(a)), 1 === a.nodeType && !K.get(a, 'hasDataAttrs'))
            ) {
              for (t = i.length; t--; )
                i[t] &&
                  0 === (r = i[t].name).indexOf('data-') &&
                  ((r = $(r.slice(5))), ee(a, r, o[r]));
      ...
      var se = {};
      function le(e, t) {
        for (var n, r, o, a, i, s, l, u = [], c = 0, d = e.length; c < d; c++)
          (r = e[c]).style &&
            ((n = r.style.display),
            t
              ? ('none' === n &&
                  ((u[c] = K.get(r, 'display') || null),
                  u[c] || (r.style.display = '')),
                '' === r.style.display &&
                  ae(r) &&
                  (u[c] =
                    ...
                    (s = o.nodeName),
                    (l = se[s]) ||
                      ((a = i.body.appendChild(i.createElement(s))),
                      (l = C.css(a, 'display')),
                      a.parentNode.removeChild(a),
                      'none' === l && (l = 'block'),
                      (se[s] = l)))))
              : 'none' !== n && ((u[c] = 'none'), K.set(r, 'display', n)));
      ...
      function ve(e, t, n, r, o) {
        ...
        for (d.textContent = '', f = 0; (a = p[f++]); )
          if (r && -1 < C.inArray(a, r)) o && o.push(a);
            ...
            ((u = C.contains(a.ownerDocument, a)),
            (i = fe(d.appendChild(a), 'script')),
            u && ge(i),
            n)
          )
      ...
      (he = A.createDocumentFragment().appendChild(A.createElement('div'))),
        (me = A.createElement('input')).setAttribute('type', 'radio'),
      ...
      (C.event = {
          ...
          if (m)
            for (
              n.handler && ((n = (a = n).handler), (o = a.selector)),
                o && C.find.matchesSelector(ye, o),
                n.guid || (n.guid = C.guid++),
                (l = m.events) || (l = m.events = {}),
                (i = m.handle) ||
                  (i = m.handle = function (e) {
              ...
              (f = h = (s = we.exec(e[u]) || [])[1]),
                ...
                f &&
                  ...
                  (p = l[f]) ||
                    ...
                    (d.setup && !1 !== d.setup.call(t, r, g, i)) ||
                      (t.addEventListener && t.addEventListener(f, i))),
                  d.add &&
                    (d.add.call(t, c),
            ...
            for (u = (t = (t || '').match(M) || ['']).length; u--; )
              if (
                ...
                i &&
                  ...
                  delete l[f]);
              } else for (f in l) C.event.remove(e, f + t[u], n, r, !0);
        ...
        dispatch: function (e) {
          ...
          if (
            ...
            for (
              i = C.event.handlers.call(this, s, u), t = 0;
              (o = i[t++]) && !s.isPropagationStopped();

            )
              for (
                s.currentTarget = o.elem, n = 0;
                (a = o.handlers[n++]) && !s.isImmediatePropagationStopped();
      ...
      function De(n, r, o, a) {
        ...
        var e,
          ...
          f = r[0],
          g = y(f);
        if (g || (1 < d && 'string' == typeof f && !v.checkClone && ke.test(f)))
        ...
        if (
          d &&
          ((t = (e = ve(r, n[0].ownerDocument, !1, n, a)).firstChild),
          1 === e.childNodes.length && (e = t),
          t || a)
        ) {
          for (s = (i = C.map(fe(e, 'script'), Le)).length; c < d; c++)
            (l = e),
              c !== p &&
                ((l = C.clone(l, !0, !0)), s && C.merge(i, fe(l, 'script'))),
              o.call(n[c], l, c);
          if (s)
            for (
              u = i[i.length - 1].ownerDocument, C.map(i, Ie), c = 0;
              c < s;
              c++
            )
              (l = i[c]),
                de.test(l.type || '') &&
                  ...
                  (l.src && 'module' !== (l.type || '').toLowerCase()
                    ...
                    : x(l.textContent.replace(Ne, ''), u, l));
        }
        return n;
      }
      function Me(e, t, n) {
        for (var r, o = t ? C.filter(t, e) : e, a = 0; null != (r = o[a]); a++)
          n || 1 !== r.nodeType || C.cleanData(fe(r)),
            r.parentNode &&
              (n && C.contains(r.ownerDocument, r) && ge(fe(r, 'script')),
      ...
      C.extend({
        ...
        clone: function (e, t, n) {
          ...
          if (
            ...
            for (i = fe(c), r = 0, o = (a = fe(e)).length; r < o; r++)
              (s = a[r]),
                (l = i[r]),
                void 0,
                'input' === (u = l.nodeName.toLowerCase()) && ue.test(s.type)
                  ? (l.checked = s.checked)
                  : ('input' !== u && 'textarea' !== u) ||
          ...
          if (t)
            if (n)
              for (
                a = a || fe(e), i = i || fe(c), r = 0, o = a.length;
                r < o;
                r++
              )
                Pe(a[r], i[r]);
          ...
          return (
            0 < (i = fe(c, 'script')).length && ge(i, !d && fe(e, 'script')), c
          );
        },
        ...
        C.each(
          ...
          function (e, i) {
            C.fn[e] = function (e) {
              for (
                var t, n = [], r = C(e), o = r.length - 1, a = 0;
                a <= o;
                a++
              )
                (t = a === o ? this : this.clone(!0)),
                  C(r[a])[i](t),
                  l.apply(n, t.get());
        ...
        function e() {
          if (l) {
            (s.style.cssText =
              ...
              ye.appendChild(s).appendChild(l);
      ...
      function Ke(e, t, n, r, o, a) {
        ...
        for (; i < 4; i += 2)
          'margin' === n && (l += C.css(e, n + oe[i], !0, o)),
            r
              ? ('content' === n && (l -= C.css(e, 'padding' + oe[i], !0, o)),
                'margin' !== n &&
                  (l -= C.css(e, 'border' + oe[i] + 'Width', !0, o)))
              : ((l += C.css(e, 'padding' + oe[i], !0, o)),
                'padding' !== n
                  ? (l += C.css(e, 'border' + oe[i] + 'Width', !0, o))
                  : (s += C.css(e, 'border' + oe[i] + 'Width', !0, o)));
        return (
          !r &&
            0 <= a &&
            (l += Math.max(
      ...
      function Je(e, t, n) {
        ...
        return (
          (i = i && (v.boxSizingReliable() || o === e.style[t])),
          ('auto' === o ||
            (!parseFloat(o) && 'inline' === C.css(e, 'display', !1, r))) &&
            ((o = e['offset' + t[0].toUpperCase() + t.slice(1)]), (i = !0)),
          (o = parseFloat(o) || 0) +
            Ke(e, t, n || (a ? 'border' : 'content'), i, r, o) +
            'px'
        );
      }
      ...
      C.extend({
        ...
        C.each({ margin: '', padding: '', border: 'Width' }, function (o, a) {
          (C.cssHooks[o + a] = {
            expand: function (e) {
              for (
                var t = 0,
      ...
      function ut(a, e, t) {
        var n,
          ...
          l = function () {
            ...
            return (
              ...
              n < 1 && o
                ? t
                : (o || s.notifyWith(a, [u, 1, 0]), s.resolveWith(a, [u]), !1)
            );
          },
          u = s.promise({
            elem: a,
            ...
            stop: function (e) {
              ...
              return (
                e
                  ? (s.notifyWith(a, [u, 1, 0]), s.resolveWith(a, [u, e]))
                  : s.rejectWith(a, [u, e]),
                this
              );
            }
        ...
        for (
          ...
          if ((n = ut.prefilters[r].call(u, a, c, u.opts)))
            return (
              y(n.stop) &&
      ...
      (C.Animation = C.extend(ut, {
        ...
        tweener: function (e, t) {
          for (
            var n, r = 0, o = (e = y(e) ? ((t = e), ['*']) : e.match(M)).length;
            r < o;
            r++
          )
            (n = e[r]),
            ...
            if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(f))
              ...
              f))
                l ||
                  ...
                  h && le([e], !0),
                  p.done(function () {
                    for (r in (h || le([e]), K.remove(e, 'fxshow'), f))
                      C.style(e, r, f[r]);
                  })),
                  (l = lt(h ? m[r] : 0, r, p)),
                  r in m ||
          ...
          stop: function (o, e, a) {
            ...
            return (
              ...
              this.each(function () {
                ...
                else for (t in r) r[t] && r[t].stop && ot.test(t) && i(r[t]);
                for (t = n.length; t--; )
                  n[t].elem !== this ||
                    (null != o && n[t].queue !== o) ||
        ...
        (tt = A.createElement('input')),
        (nt = A.createElement('select').appendChild(A.createElement('option'))),
        (tt.type = 'checkbox'),
        (v.checkOn = '' !== tt.value),
        (v.optSelected = nt.selected),
        ((tt = A.createElement('input')).value = 't'),
        (tt.type = 'radio'),
        ...
        C.fn.extend({
          ...
          hasClass: function (e) {
            var t,
              ...
              r = 0;
            for (t = ' ' + e + ' '; (n = this[r++]); )
              if (1 === n.nodeType && -1 < (' ' + gt(ht(n)) + ' ').indexOf(t))
                return !0;
            return !1;
          }
        });
            ...
            select: {
              ...
              set: function (e, t) {
                for (
                  ...
                  ((r = o[i]).selected =
                    -1 < C.inArray(C.valHooks.option.get(r), a)) && (n = !0);
      ...
      C.extend(C.event, {
        trigger: function (e, t, n, r) {
          ...
          if (
            ...
            3 !== n.nodeType &&
              8 !== n.nodeType &&
              !yt.test(f + C.event.triggered) &&
              (-1 < f.indexOf('.') &&
                ((f = (g = f.split('.')).shift()), g.sort()),
              (l = f.indexOf(':') < 0 && 'on' + f),
              ((e = e[C.expando]
                ? e
            ...
            if (!r && !c.noBubble && !h(n)) {
              for (
                s = c.delegateType || f, yt.test(s + f) || (a = a.parentNode);
                a;
                a = a.parentNode
              )
                p.push(a), (i = a);
              i === (n.ownerDocument || A) &&
                p.push(i.defaultView || i.parentWindow || E);
            }
            ...
            return (
              ...
              r ||
                ...
                (l &&
                  ...
                  ((i = n[l]) && (n[l] = null),
                  (C.event.triggered = f),
                  e.isPropagationStopped() && d.addEventListener(f, vt),
                  n[f](),
                  e.isPropagationStopped() && d.removeEventListener(f, vt),
          ...
          C.each({ focus: 'focusin', blur: 'focusout' }, function (n, r) {
            ...
            C.event.special[r] = {
              ...
              teardown: function () {
                ...
                t
                  ? K.access(e, r, t)
                  : (e.removeEventListener(n, o, !0), K.remove(e, r));
              }
            };
          });
      var xt = E.location,
      ...
      function Rt(n, e, r, o) {
        ...
        else for (t in e) Rt(n + '[' + t + ']', e[t], r, o);
      }
      ...
      (jt.href = xt.href),
        C.extend({
          ...
          ajax: function (e, t) {
            ...
            if (
              ...
              try {
                (r.href = m.url),
                  (r.href = r.href),
                  (m.crossDomain =
                    jt.protocol + '//' + jt.host != r.protocol + '//' + r.host);
              } catch (e) {
                m.crossDomain = !0;
              }
            }
            ...
            m.hasContent
              ...
              : ((a = m.url.slice(d.length)),
                m.data &&
                  ...
                  ((d += (wt.test(d) ? '&' : '?') + m.data), delete m.data),
                !1 === m.cache &&
                  ((d = d.replace(Nt, '$1')),
                  (a = (wt.test(d) ? '&' : '?') + '_=' + _t++ + a)),
                (m.url = d + a)),
            ...
            m.headers))
              w.setRequestHeader(o, m.headers[o]);
            if (m.beforeSend && (!1 === m.beforeSend.call(b, w, m) || g))
              return w.abort();
            if (
              ((l = 'abort'),
              x.add(m.complete),
              ...
              if (((w.readyState = 1), h && v.trigger('ajaxSend', [w, m]), g))
                return w;
              m.async &&
                0 < m.timeout &&
                ...
                o
                  ? (m.ifModified &&
                      ((l = w.getResponseHeader('Last-Modified')) &&
                        (C.lastModified[d] = l),
                      (l = w.getResponseHeader('etag')) && (C.etag[d] = l)),
                    204 === e || 'HEAD' === m.type
                      ? (u = 'nocontent')
                      : 304 === e
                      ? (u = 'notmodified')
                      : ((u = s.state), (a = s.data), (o = !(i = s.error))))
                  : ((i = u), (!e && u) || ((u = 'error'), e < 0 && (e = 0))),
                (w.status = e),
                (w.statusText = (t || u) + ''),
                o ? y.resolveWith(b, [a, u, w]) : y.rejectWith(b, [w, u, i]),
                w.statusCode(_),
                (_ = void 0),
                h &&
                  v.trigger(o ? 'ajaxSuccess' : 'ajaxError', [w, m, o ? a : i]),
                x.fireWith(b, [w, u]),
                h &&
            ...
            return {
              send: function (e, t) {
                ...
                (a = function (e) {
                  return function () {
                    a &&
                      ((a = i = r.onload = r.onerror = r.onabort = r.ontimeout = r.onreadystatechange = null),
                      'abort' === e
                        ? r.abort()
                        : 'error' === e
                  ...
                  (r.onload = a()),
                  (i = r.onerror = r.ontimeout = a('error')),
                  void 0 !== r.onabort
                    ? (r.onabort = i)
      ...
      C.ajaxSetup({
          ...
          return (
            ...
            0 < i.length &&
              C.ajax({ url: e, type: o || 'GET', dataType: 'html', data: t })
                .done(function (e) {
                  (a = arguments),
                    i.html(r ? C('<div>').append(C.parseHTML(e)).find(r) : e);
                })
                .always(
                  n &&
                    function (e, t) {
              ...
              return W(
                ...
                function (e, t, n) {
                  ...
                  if (
                    ...
                    return r ? r[o] : e[t];
                  r
                    ? r.scrollTo(a ? r.pageXOffset : n, a ? n : r.pageYOffset)
                    : (e[t] = n);
                },
                t,
                e,
        ...
        C.each(['top', 'left'], function (e, n) {
          C.cssHooks[n] = Fe(v.pixelPosition, function (e, t) {
            if (t)
              return (t = Ue(e, n)), je.test(t) ? C(e).position()[n] + 'px' : t;
          });
        }),
        C.each({ Height: 'height', Width: 'width' }, function (i, s) {
          C.each(
      ...
      return (
        (C.noConflict = function (e) {
          return (
            E.$ === C && (E.$ = $t), e && E.jQuery === C && (E.jQuery = Yt), C
          );
        }),
        e || (E.jQuery = E.$ = C),
        C
  ...
  function (e, t, p) {
    ...
    e.exports = function t(e, n) {
      ...
      for (
        var u = arguments.length, c = Array(2 < u ? u - 2 : 0), d = 2;
        d < u;
        d++
      )
        c[d - 2] = arguments[d];
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, i) {
      ...
      ((i = i || {}).attrs = 'object' == typeof i.attrs ? i.attrs : {}),
        i.singleton || 'boolean' == typeof i.singleton || (i.singleton = u()),
      ...
      (e.exports = function (e) {
        function n(e, t) {
          var n = a('<div>')
            ...
            .css(e.position())
            .data({ $el: e });
          return o.push({ $annotation: n, $parent: e.offsetParent() }), n;
        }
        ...
        return (
          ...
          a(window).resize(function () {
            ...
            e.each(function (e, t) {
              a(t).css({ top: n[e].top, left: n[e].left });
            });
          }),
          {
            label: function (e) {
            ...
            errorLabel: function (e, t, n, r) {
              var o = a(i({ text: t, detail: n, hasErrorEntry: !!r }));
              return (
                r &&
                  (o.find('.tota11y-label-link').click(function (e) {
  ...
  function (e, t, n) {
    ...
    function l(e, t) {
      ...
      for (
        var a = Error.prototype.constructor.call(this, e), i = 0;
        i < s.length;
        i++
      )
        this[s[i]] = a[s[i]];
  ...
  function (e, t, n) {
    ...
    function r(t) {
      ...
      return (
        (n.showUnsupportedRulesWarning = !1),
        n.ignoreSelectors(t, '.tota11y *'),
      ...
      return (
        (axs.AuditRule.collectMatchingElements = function (e, t, n, r) {
          ...
          if ((o && t.call(null, o) && n.push(o), o)) {
            ...
            if (a)
              return void axs.AuditRule.collectMatchingElements(a, t, n, a);
          }
          if (o && 'content' == o.localName)
            for (var i = o.getDistributedNodes(), s = 0; s < i.length; s++)
              axs.AuditRule.collectMatchingElements(i[s], t, n, r);
          else {
            if (o && 'shadow' == o.localName)
              if (r)
                for (i = o.getDistributedNodes(), s = 0; s < i.length; s++)
                  axs.AuditRule.collectMatchingElements(i[s], t, n, r);
              else console.warn('ShadowRoot not provided for', o);
            for (var l = e.firstChild; null != l; )
              axs.AuditRule.collectMatchingElements(l, t, n, r),
                (l = l.nextSibling);
          }
        }),
              ...
              value: function (e) {
                var t = this,
                  ...
                  o = c.default.map(function (e) {
                    return l(e, { onClick: t.handlePluginClick.bind(t) });
                  }),
                  a = null;
                c.experimental.length &&
                  (a = l(
                    'li',
                    null,
                    l(
                    ...
                    l(
                      'ul',
                      null,
                      c.experimental.map(function (e) {
                        return l(e, { onClick: t.handlePluginClick.bind(t) });
                      })
                    )
                  ));
                var i = l('ul', { className: 'tota11y-plugins' }, o, a),
                  s = l(
                    'button',
                    {
                      ...
                      onClick: function (e) {
                        e.preventDefault(),
                          e.stopPropagation(),
                          r.toggleClass('tota11y-expanded'),
                          r.attr('aria-expanded', r.is('.tota11y-expanded'));
                      },
                ...
                (r = l(
                  ...
                  l('div', { className: 'tota11y-toolbar-body' }, i),
                  s
                )),
                  e.append(r);
              }
                    ...
                    o = i(
                      ...
                      i(
                        ...
                        i(
                          'code',
                          null,
                          '&lt;img src="' + n + '" alt="Image description"&gt'
                        )
                      ),
                      i(
                        'p',
            ...
            e(t, [
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  return (
                    this.$el.find('.tota11y-info-sections').append(o),
                    r.on('activate', function () {
                      n.$el
                  ...
                  this.$el
                    ...
                    .click(function (e) {
                      e.preventDefault(),
                        e.stopPropagation(),
                        r.$el.addClass(g),
                        r.plugin.$checkbox.focus();
                    }),
                    d('body').append(this.$el),
                    (o = window.innerWidth - this.$el.width() - 10),
                    (a = window.innerHeight - this.$el.height() - 10);
                  ...
                  e
                    ...
                    d(window).on('mousemove', function (e) {
                      if (i) {
                        ...
                        (o = u + t),
                          (a = c + n),
                          r.$el.css({ left: o, top: a });
                      }
                    }),
                    this.$el.css({ left: o, top: a });
                }
              },
              {
                key: 'render',
                value: function () {
                  ...
                  this.$el = a(
                    ...
                    a(
                      ...
                      a('div', { className: 'tota11y-info-sections' }),
                      a('ul', {
                        role: 'tablist',
                  ...
                  var t = void 0;
                  if (
                    (this.about && (t = this._addTab('About', this.about)),
                    this.summary && (t = this._addTab('Summary', this.summary)),
                    ...
                    this.errors.forEach(function (t, e) {
                      ...
                      r.click(function (e) {
                        ...
                        (t.show = function () {
                          s.$el.removeClass(g),
                            ...
                            o.removeClass(f),
                            u.trigger('activate'),
                            (r.parents('.tota11y-info-section')[0].scrollTop =
                              r[0].offsetTop - 10);
                        }),
                        (t.$trigger = r);
                      ...
                      a.click(function (e) {
                        e.preventDefault(),
                          e.stopPropagation(),
                          d(document).scrollTop(t.$el.offset().top - 80);
                      }),
                        0 === e && (o.toggleClass(f), r.toggleClass(f)),
                        c.toggleHighlight(t.$el, r),
                        c.toggleHighlight(t.$el, a);
                      var i = t.$el[0].outerHTML;
                      300 < i.length && (i = i.substring(0, 300) + '...'),
                        n
                          .find(
                  ...
                  return (
                    t && (t.trigger('activate'), (e = !0)),
                    e && this.initAndPosition(),
                    this.$el.focus(),
                    this.$el
                  );
                }
    ...
    e.exports = (r.default || r).template({
      ...
      main: function (e, t, n, r, o) {
        ...
        return (
          ...
          (a =
            typeof (i =
              null != (i = n.text || (null != t ? t.text : t)) ? i : l) == u
              ? i.call(s, { name: 'text', hash: {}, data: o })
              : i)
            ? a
            : '') +
          '</div>\n' +
          (null !=
          (a = n.if.call(s, null != t ? t.hasErrorEntry : t, {
            name: 'if',
            hash: {},
            fn: e.program(1, o, 0),
            inverse: e.noop,
          ...
          (a =
            typeof (i =
              null != (i = n.detail || (null != t ? t.detail : t)) ? i : l) == u
              ? i.call(s, { name: 'detail', hash: {}, data: o })
              : i)
            ? a
            : '') +
          '</div>\n</span>\n'
  ...
  function (e, t, n) {
    ...
    (t.default = function (a) {
      a.registerHelper('blockHelperMissing', function (e, t) {
        ...
        if (i.isArray(e))
          return 0 < e.length
            ? (t.ids && (t.ids = [t.name]), a.helpers.each(e, t))
            : n(this);
        if (t.data && t.ids) {
          var o = i.createFrame(t.data);
          (o.contextPath = i.appendContextPath(t.data.contextPath, t.name)),
            (t = { data: o });
        }
        return r(e, t);
      });
    ...
    (t.default = function (e) {
      e.registerHelper('each', function (r, e) {
        ...
        if (
          (e.data &&
            e.ids &&
            (s = p.appendContextPath(e.data.contextPath, e.ids[0]) + '.'),
          p.isFunction(r) && (r = r.call(this)),
          e.data && (i = p.createFrame(e.data)),
          r && 'object' == typeof r)
        )
          if (p.isArray(r))
            for (var u = r.length; n < u; n++)
              n in r && l(n, n, n === r.length - 1);
          else {
            var c = void 0;
            for (var d in r)
              r.hasOwnProperty(d) &&
                (void 0 !== c && l(c, n - 1), (c = d), n++);
            void 0 !== c && l(c, n - 1, !0);
          }
      ...
      (t.template = function (s, l) {
        ...
        var i = {
          ...
          invokePartial: function (e, t, n) {
            ...
            null == r &&
              l.compile &&
              ((n.partials[n.name] = l.compile(e, s.compilerOptions, l)),
            ...
            s.useDepths &&
              (r = t.depths
                ? e != t.depths[0]
                  ...
                  : t.depths
                : [e]),
            (a = g(s.main, a, i, t.depths || [], n, o))(e, t)
          );
        }
        return (
          (u.isTop = !0),
          (u._setup = function (e) {
            e.partial
              ...
              : ((i.helpers = i.merge(e.helpers, l.helpers)),
                s.usePartial && (i.partials = i.merge(e.partials, l.partials)),
                (s.usePartial || s.useDecorators) &&
                  (i.decorators = i.merge(e.decorators, l.decorators)));
          }),
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function (e, t) {
              var n = e.style,
                ...
                a = e.contrastRatio,
                i = e.requiredRatio,
                s = axs.color.suggestColors(o, r, { AA: i }).AA,
                l = {
                ...
                d = n.backgroundColor;
              return (
                u.find('.preview-contrast-fix').click(function (e) {
                  p(e.target).prop('checked')
                    ? (p(t).css('color', s.fg),
                      p(t).css('background-color', s.bg))
                    : (p(t).css('color', c), p(t).css('background-color', d));
                }),
          ...
          },
          {
            ...
            value: function () {
              ...
              p('*').each(function (e, t) {
                if (
                  axs.properties.hasDirectTextDescendant(t) &&
                  !(
                    0 < p(t).parents('.tota11y').length ||
                    axs.utils.elementIsTransparent(t) ||
                    axs.utils.elementHasZeroArea(t)
                  )
                ) {
                  ...
                  if (axs.utils.isLowContrast(a, n)) {
                    ...
                    c[s] ||
                      (d.label(p(t), a).addClass('tota11y-label-success'),
                      (c[s] = !0));
                }
              });
            }
    ...
    e.exports = (r.default || r).template({
      ...
      main: function (e, t, n, r, o) {
        ...
        return (
          ...
          u(
            typeof (a =
              null != (a = n.contrastRatio || (null != t ? t.contrastRatio : t))
                ? a
                : s) == l
              ? a.call(i, { name: 'contrastRatio', hash: {}, data: o })
              : a
          ) +
          ' &lt; ' +
          u(
            typeof (a =
              null != (a = n.requiredRatio || (null != t ? t.requiredRatio : t))
                ? a
                : s) == l
              ? a.call(i, { name: 'requiredRatio', hash: {}, data: o })
              : a
          ) +
          ')\n\n<span class="tota11y-swatches">\n    <span class="tota11y-swatch" style="background-color: ' +
          u(
            typeof (a =
              null != (a = n.fgColorHex || (null != t ? t.fgColorHex : t))
                ? a
                : s) == l
              ? a.call(i, { name: 'fgColorHex', hash: {}, data: o })
              : a
          ) +
          ' !important"></span>\n    /\n    <span class="tota11y-swatch" style="background-color: ' +
          u(
            typeof (a =
              null != (a = n.bgColorHex || (null != t ? t.bgColorHex : t))
                ? a
                : s) == l
              ? a.call(i, { name: 'bgColorHex', hash: {}, data: o })
              : a
          ) +
          ' !important"></span>\n</span>\n'
        );
        ...
        return (
          ...
          u(
            typeof (a =
              null !=
              (a =
                n.suggestedFgColorHex ||
                (null != t ? t.suggestedFgColorHex : t))
                ? a
                : s) == l
              ? a.call(i, { name: 'suggestedFgColorHex', hash: {}, data: o })
              : a
          ) +
          '/' +
          u(
            typeof (a =
              null !=
              (a =
                n.suggestedBgColorHex ||
                (null != t ? t.suggestedBgColorHex : t))
                ? a
                : s) == l
              ? a.call(i, { name: 'suggestedBgColorHex', hash: {}, data: o })
              : a
          ) +
          ...
          u(
            typeof (a =
              null !=
              (a =
                n.suggestedColorsRatio ||
                (null != t ? t.suggestedColorsRatio : t))
                ? a
                : s) == l
              ? a.call(i, { name: 'suggestedColorsRatio', hash: {}, data: o })
              : a
          ) +
                  ...
                  return (
                    e.each(function (e, t) {
                      ...
                      0 === e && 1 != r
                        ? (o = f(r))
                        : u && 1 < r - u && (o = g(u, r));
                      var a = c(p({ level: (u = r), text: n.text() }));
    ...
    e.exports = (r.default || r).template({
      ...
      main: function (e, t, n, r, o) {
        ...
        return (
          ...
          u(
            typeof (a =
              null != (a = n.level || (null != t ? t.level : t)) ? a : s) == l
              ? a.call(i, { name: 'level', hash: {}, data: o })
              : a
          ) +
          ...
          u(
            typeof (a =
              null != (a = n.text || (null != t ? t.text : t)) ? a : s) == l
              ? a.call(i, { name: 'text', hash: {}, data: o })
              : a
          ) +
          '</span>\n</div>\n'
        );
  ...
  function (e, t, n) {
    ...
    e.exports = (r.default || r).template({
      ...
      5: function (e, t, n, r, o) {
        ...
        return (
          ...
          e.escapeExpression(
            'function' ==
              typeof (a =
                null != (a = n.tagName || (null != t ? t.tagName : t))
                  ? a
                  : n.helperMissing)
              ? a.call(null != t ? t : e.nullContext || {}, {
                  name: 'tagName',
      ...
      main: function (e, t, n, r, o) {
        ...
        return (
          (null !=
          (a = n.if.call(i, null != t ? t.placeholder : t, {
            name: 'if',
            hash: {},
            fn: e.program(1, o, 0),
            inverse: e.noop,
        ...
        return (
          ...
          r(t, [
            ...
            },
            {
              key: 'run',
              value: function () {
                o('[role]:not(.tota11y-toolbar,.tota11y-plugin)').each(
                  function () {
            ...
            n(t, [
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    '' !==
                    (e = e.replace(/[^a-zA-Z ]/g, '').replace(t, '')).trim()
                  );
                }
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  s('a').each(function (e, t) {
                    var n = s(t);
                    if (
                      !n.parents('.tota11y').length &&
                      !axs.utils.isElementOrAncestorHidden(t)
                    ) {
          ...
          n(t, [
            ...
            },
            {
              ...
              value: function () {
                this.summary(' '),
                  this.panel.render(),
                  o(document).on('mousemove.wand', function (e) {
                    var t = document.elementFromPoint(e.clientX, e.clientY),
                      n = axs.properties.findTextAlternatives(t, {});
                    o('.tota11y-outlined').removeClass('tota11y-outlined'),
                      o(t).addClass('tota11y-outlined'),
                      n
                        ? o('.tota11y-info-section.active').text(n)
                        : o('.tota11y-info-section.active').html(
                            r(
                              'i',
