...
- Be sure you've loaded the alert plugin, or the compiled UiDSystem JavaScript.
...
UiDSystem's alert plugin exposes a few events for hooking into alert functionality.
