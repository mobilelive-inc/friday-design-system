...
Use the tab JavaScript plugin—include it individually or through the compiled `UiDSystem.js` file—to extend our list group to create tabbable panes of local content.
