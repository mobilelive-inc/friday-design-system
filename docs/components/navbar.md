...
layout: docs
title: Navbar
description: Documentation and examples for UiDSystem's powerful, responsive navigation header, the navbar. Includes support for branding, navigation, and more, including support for our collapse plugin.
group: components
toc: true
---
...
<nav class="navbar navbar-light bg-light">
  <a class="navbar-brand" href="#">
    <img src="{{ site.baseurl }}/docs/{{ site.docs_version }}/assets/brand/UiDSystem-solid.svg" width="30" height="30" alt="" loading="lazy">
  </a>
</nav>
{% endcapture %}
{% include example.html content=example %}
...
<nav class="navbar navbar-light bg-light">
  <a class="navbar-brand" href="#">
    <img src="{{ site.baseurl }}/docs/{{ site.docs_version }}/assets/brand/UiDSystem-solid.svg" width="30" height="30" class="d-inline-block align-top" alt="" loading="lazy">
    UiDSystem
  </a>
</nav>
{% endcapture %}
