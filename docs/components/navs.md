...
layout: docs
title: Navs
description: Documentation and examples for how to use UiDSystem's included navigation components.
group: components
toc: true
---
...
Navigation available in UiDSystem share general markup and styles, from the base `.nav` class to the active and disabled states. Swap modifier classes to switch between each style.
...
Use the tab JavaScript plugin—include it individually or through the compiled `UiDSystem.js` file—to extend our navigational tabs and pills to create tabbable panes of local content, even via dropdown menus.
