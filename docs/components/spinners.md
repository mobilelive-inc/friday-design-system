...
layout: docs
title: Spinners
description: Indicate the loading state of a component or page with UiDSystem spinners, built entirely with HTML, CSS, and no JavaScript.
group: components
toc: true
---
...
Spinners in UiDSystem are built with `rem`s, `currentColor`, and `display: inline-flex`. This means they can easily be resized, recolored, and quickly aligned.
