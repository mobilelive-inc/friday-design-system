...
layout: docs
title: Tooltips
description: Documentation and examples for adding custom UiDSystem tooltips with CSS and JavaScript using CSS3 for animations and data-attributes for local title storage.
group: components
toc: true
---
...
- Tooltips rely on the 3rd party library [Popper.js](https://popper.js.org/) for positioning. You must include [popper.min.js]({{ site.cdn.popper }}) before UiDSystem.js or use `UiDSystem.bundle.min.js` / `UiDSystem.bundle.js` which contains Popper.js in order for tooltips to work!
