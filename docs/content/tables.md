...
layout: docs
title: Tables
description: Documentation and examples for opt-in styling of tables (given their prevalent use in JavaScript plugins) with UiDSystem.
group: content
toc: true
---
...
Using the most basic table markup, here's how `.table`-based tables look in UiDSystem. **All table styles are inherited in UiDSystem 4**, meaning any nested tables will be styled in the same manner as the parent.
