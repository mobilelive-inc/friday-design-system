import {
  ...
  OnDestroy,
  OnInit, Optional,
  Output, QueryList, Renderer2, Self, TemplateRef, ViewChild, ViewEncapsulation
} from "@angular/core";
...
export class AutocompleteComponent implements AfterViewChecked, AfterContentInit, OnDestroy, ControlValueAccessor {
